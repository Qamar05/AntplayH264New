 ...
 */
JNIEXPORT jstring JNICALL Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1GetFFmpegVersion
 ...
 */
JNIEXPORT jlong JNICALL Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1Init
        (JNIEnv *env, jobject obj, jstring jurl, int playerType, jint renderType, jobject surface) {
    const char *url = env->GetStringUTFChars(jurl, nullptr);

    PlayerWrapper *player = new PlayerWrapper();
    player->Init(env, obj ,   jurl ,const_cast<char *>(url), playerType, renderType, surface);
 ...
 * Signature: (J)V
// */
JNIEXPORT void JNICALL Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1Play
...
Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1SeekToPosition(JNIEnv *env, jobject thiz,
...
Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1GetMediaParams(JNIEnv *env, jobject thiz,
                                                                         jlong player_handle,
                                                                         jint param_type) {
    long value = 0;
    if(player_handle != 0)
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1SetMediaParams(JNIEnv *env, jobject thiz,
                                                                         jlong player_handle,
                                                                         jint param_type,
                                                                         jobject param) {
    if(player_handle != 0)
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1Pause
(JNIEnv *env, jobject obj, jlong player_handle)
{
    if(player_handle != 0)
    {
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1Stop
(JNIEnv *env, jobject obj, jlong player_handle)
{
    if(player_handle != 0)
    {
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1UnInit
(JNIEnv *env, jobject obj, jlong player_handle)
{
    if(player_handle != 0)
    {
...
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1OnSurfaceCreated(JNIEnv *env,
                                                                           jclass clazz,
                                                                           jint render_type) {
    switch (render_type)
    {
...
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1OnSurfaceChanged(JNIEnv *env, jclass clazz,
                                                                           jint render_type,
                                                                           jint width,
                                                                           jint height) {
    switch (render_type)
...
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1OnDrawFrame(JNIEnv *env, jclass clazz, jint render_type) {
    switch (render_type)
    {
        case VIDEO_GL_RENDER:
...
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1SetGesture(JNIEnv *env, jclass clazz,
                                                                     jint   render_type,
...
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_FFMediaPlayer_native_1SetTouchLoc(JNIEnv *env, jclass clazz,
                                                                      jint   render_type,
                                                                      jfloat touch_x,
                                                                      jfloat touch_y) {
    switch (render_type)
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1CreateContext(JNIEnv *env,
                                                                                jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1DestroyContext(JNIEnv *env,
                                                                                 jobject thiz) {
...
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1Init(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1UnInit(JNIEnv *env, jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1StartRecord(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jint recorder_type,
                                                                             jstring out_url,
                                                                             jint frame_width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1OnAudioData(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jbyteArray data,
                                                                             jint size) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1StopRecord(JNIEnv *env,
                                                                            jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1OnPreviewFrame(JNIEnv *env,
                                                                                 jobject thiz,
                                                                                 jint format,
                                                                                 jbyteArray data,
                                                                                 jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1SetTransformMatrix(JNIEnv *env,
                                                                                     jobject thiz,
                                                                                     jfloat translate_x,
                                                                                     jfloat translate_y,
                                                                                     jfloat scale_x,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1OnSurfaceCreated(JNIEnv *env,
                                                                                   jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1OnSurfaceChanged(JNIEnv *env,
                                                                                   jobject thiz,
                                                                                   jint width,
                                                                                   jint height) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1OnDrawFrame(JNIEnv *env, jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1SetFilterData(JNIEnv *env,
                                                                               jobject thiz,
                                                                               jint index,
                                                                               jint format,
                                                                               jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_vmstechs_antplay_media_MediaRecorderContext_native_1SetFragShader(JNIEnv *env,
                                                                               jobject thiz,
                                                                               jint index,
                                                                               jstring str) {

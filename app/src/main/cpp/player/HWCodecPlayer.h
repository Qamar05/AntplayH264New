...
public:
    ...
    virtual void Init(JNIEnv *jniEnv, jobject obj , jstring  jurl , char *url, int renderType, jobject surface);
    virtual void UnInit();
    virtual void Play();
    virtual void Pause();
    virtual void Stop();
...
//    virtual void OnFrameAvailable(AVFrame *frame) = 0;
   ...
   // static void AudioDecodeThreadPro/c(HWCodecPlayer* player);
...
private:
    ...
    AVMediaType      m_MediaType = AVMEDIA_TYPE_VIDEO;

...
import static com.vmstechs.antplay.media.FFMediaPlayer.HWCODEC_PLAYER;
import static com.vmstechs.antplay.media.FFMediaPlayer.MEDIA_PARAM_ASSET_MANAGER;
...
public class FFMediaCodecPlayerActivity extends AppCompatActivity implements SurfaceHolder.Callback, FFMediaPlayer.EventCallback{
    ...
    private String mVideoPath = "tcp://103.182.65.242:9001";
    @Override
